...
Sub btniniciaracudinte_Click
	If txtcorreoacudiente.Text <> "" And txtContrasenaacudiente.Text <> "" Then
		...
		job.PostString(ApiAddress,"SELECT * FROM tblregistroacudiente where correoAcudiente= '" & txtcorreoacudiente.Text & "'and contrasenaAcudiente='"&txtContrasenaacudiente.Text&"'")
	Else
