			...
			If txtcorreoAcudiente.Text.Contains("@") Then
				If txtcorreoAcudiente.Text.Contains(".") Then
					...
					Else
						...
						Dim job As HttpJob
						job.Initialize("", Me)
						job.PostString(ApiAddress,"INSERT INTO tblregistroacudiente(nombreAcudiente, apellidoAcudiente, cedulaAcudiente, codigoAcudiente, correoAcudiente, contrasenaAcudiente) VALUES ('"&txtnombreAcudiente.Text&"','"&txtapellidoAcudiente.Text&"','"&txtcedulaAcudiente.Text&"','"&txtcodigoAcuente.Text&"','"&txtcorreoAcudiente.Text&"','"&txtcontrasenaAcudiente.Text&"')")
					End If
				Else
