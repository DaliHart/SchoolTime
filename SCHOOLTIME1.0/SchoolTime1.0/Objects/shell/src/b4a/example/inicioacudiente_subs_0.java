...
try {
		Debug.PushSubsStack("Activity_Create (inicioacudiente) ","inicioacudiente",8,inicioacudiente.mostCurrent.activityBA,inicioacudiente.mostCurrent,22);
...
try {
		Debug.PushSubsStack("Activity_Pause (inicioacudiente) ","inicioacudiente",8,inicioacudiente.mostCurrent.activityBA,inicioacudiente.mostCurrent,31);
...
try {
		Debug.PushSubsStack("Activity_Resume (inicioacudiente) ","inicioacudiente",8,inicioacudiente.mostCurrent.activityBA,inicioacudiente.mostCurrent,27);
...
try {
		Debug.PushSubsStack("btniniciaracudinte_Click (inicioacudiente) ","inicioacudiente",8,inicioacudiente.mostCurrent.activityBA,inicioacudiente.mostCurrent,57);
...
if (RemoteObject.solveBoolean("!",inicioacudiente.mostCurrent._txtcorreoacudiente.runMethod(true,"getText"),BA.ObjectToString("")) && RemoteObject.solveBoolean("!",inicioacudiente.mostCurrent._txtcontrasenaacudiente.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 59;BA.debugLine="Dim ApiAddress As String = \"http://192.168.1.3/s";
Debug.ShouldStop(67108864);
...
_job.runClassMethod (b4a.example.httpjob.class, "_initialize" /*RemoteObject*/ ,inicioacudiente.processBA,(Object)(BA.ObjectToString("usuario_existe")),(Object)(inicioacudiente.getObject()));
 BA.debugLineNum = 62;BA.debugLine="job.PostString(ApiAddress,\"SELECT * FROM tblregi";
Debug.ShouldStop(536870912);
_job.runClassMethod (b4a.example.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(_apiaddress),(Object)(RemoteObject.concat(RemoteObject.createImmutable("SELECT * FROM tblregistroacudiente where correoAcudiente= '"),inicioacudiente.mostCurrent._txtcorreoacudiente.runMethod(true,"getText"),RemoteObject.createImmutable("'and contrasenaAcudiente='"),inicioacudiente.mostCurrent._txtcontrasenaacudiente.runMethod(true,"getText"),RemoteObject.createImmutable("'"))));
 }else {
...
try {
		Debug.PushSubsStack("JobDone (inicioacudiente) ","inicioacudiente",8,inicioacudiente.mostCurrent.activityBA,inicioacudiente.mostCurrent,68);
...
inicioacudiente.mostCurrent.__c.runVoidMethod ("LogImpl","57405587",_job.getField(true,"_errormessage" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("opcionregistro_Click (inicioacudiente) ","inicioacudiente",8,inicioacudiente.mostCurrent.activityBA,inicioacudiente.mostCurrent,52);
...
try {
		Debug.PushSubsStack("retroceder_Click (inicioacudiente) ","inicioacudiente",8,inicioacudiente.mostCurrent.activityBA,inicioacudiente.mostCurrent,47);
...
try {
		Debug.PushSubsStack("txtContrasenaacudiente_TextChanged (inicioacudiente) ","inicioacudiente",8,inicioacudiente.mostCurrent.activityBA,inicioacudiente.mostCurrent,41);
...
try {
		Debug.PushSubsStack("txtcorreoacudiente_TextChanged (inicioacudiente) ","inicioacudiente",8,inicioacudiente.mostCurrent.activityBA,inicioacudiente.mostCurrent,35);
