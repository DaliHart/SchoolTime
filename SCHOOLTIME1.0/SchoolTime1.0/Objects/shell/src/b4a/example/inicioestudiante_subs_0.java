...
try {
		Debug.PushSubsStack("Activity_Create (inicioestudiante) ","inicioestudiante",9,inicioestudiante.mostCurrent.activityBA,inicioestudiante.mostCurrent,23);
...
try {
		Debug.PushSubsStack("Activity_Pause (inicioestudiante) ","inicioestudiante",9,inicioestudiante.mostCurrent.activityBA,inicioestudiante.mostCurrent,33);
...
try {
		Debug.PushSubsStack("Activity_Resume (inicioestudiante) ","inicioestudiante",9,inicioestudiante.mostCurrent.activityBA,inicioestudiante.mostCurrent,29);
...
try {
		Debug.PushSubsStack("btninicioEstudiante_Click (inicioestudiante) ","inicioestudiante",9,inicioestudiante.mostCurrent.activityBA,inicioestudiante.mostCurrent,59);
...
if (RemoteObject.solveBoolean("!",inicioestudiante.mostCurrent._txtcorreoestudiante.runMethod(true,"getText"),BA.ObjectToString("")) && RemoteObject.solveBoolean("!",inicioestudiante.mostCurrent._txtcontrasenaestudiante.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 61;BA.debugLine="Dim ApiAddress As String = \"http://192.168.1.3/s";
Debug.ShouldStop(268435456);
...
_job.runClassMethod (b4a.example.httpjob.class, "_initialize" /*RemoteObject*/ ,inicioestudiante.processBA,(Object)(BA.ObjectToString("usuario_existe")),(Object)(inicioestudiante.getObject()));
 BA.debugLineNum = 64;BA.debugLine="job.PostString(ApiAddress,\"SELECT * FROM tblregi";
Debug.ShouldStop(-2147483648);
_job.runClassMethod (b4a.example.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(_apiaddress),(Object)(RemoteObject.concat(RemoteObject.createImmutable("SELECT * FROM tblregistroestudiante where correoEstudiante= '"),inicioestudiante.mostCurrent._txtcorreoestudiante.runMethod(true,"getText"),RemoteObject.createImmutable("'and contrasenaEstudiante='"),inicioestudiante.mostCurrent._txtcontrasenaestudiante.runMethod(true,"getText"),RemoteObject.createImmutable("'"))));
 }else {
...
try {
		Debug.PushSubsStack("JobDone (inicioestudiante) ","inicioestudiante",9,inicioestudiante.mostCurrent.activityBA,inicioestudiante.mostCurrent,70);
...
try {
		Debug.PushSubsStack("opcionregistro_Click (inicioestudiante) ","inicioestudiante",9,inicioestudiante.mostCurrent.activityBA,inicioestudiante.mostCurrent,37);
...
try {
		Debug.PushSubsStack("retroceder_Click (inicioestudiante) ","inicioestudiante",9,inicioestudiante.mostCurrent.activityBA,inicioestudiante.mostCurrent,42);
...
try {
		Debug.PushSubsStack("txtcontrasenaEstudiante_TextChanged (inicioestudiante) ","inicioestudiante",9,inicioestudiante.mostCurrent.activityBA,inicioestudiante.mostCurrent,53);
...
try {
		Debug.PushSubsStack("txtcorreoEstudiante_TextChanged (inicioestudiante) ","inicioestudiante",9,inicioestudiante.mostCurrent.activityBA,inicioestudiante.mostCurrent,47);
