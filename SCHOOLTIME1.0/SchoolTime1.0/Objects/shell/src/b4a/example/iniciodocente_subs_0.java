...
try {
		Debug.PushSubsStack("Activity_Create (iniciodocente) ","iniciodocente",3,iniciodocente.mostCurrent.activityBA,iniciodocente.mostCurrent,23);
...
try {
		Debug.PushSubsStack("Activity_Pause (iniciodocente) ","iniciodocente",3,iniciodocente.mostCurrent.activityBA,iniciodocente.mostCurrent,33);
...
try {
		Debug.PushSubsStack("Activity_Resume (iniciodocente) ","iniciodocente",3,iniciodocente.mostCurrent.activityBA,iniciodocente.mostCurrent,29);
...
try {
		Debug.PushSubsStack("btniniciardococente_Click (iniciodocente) ","iniciodocente",3,iniciodocente.mostCurrent.activityBA,iniciodocente.mostCurrent,59);
...
_job.runClassMethod (b4a.example.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(_apiaddress),(Object)(RemoteObject.concat(RemoteObject.createImmutable("SELECT * FROM tblregistrodocente where correoDocente= '"),iniciodocente.mostCurrent._txtcorreodococente.runMethod(true,"getText"),RemoteObject.createImmutable("'and contrasenaDocente='"),iniciodocente.mostCurrent._txtcontrasenadocente.runMethod(true,"getText"),RemoteObject.createImmutable("'"))));
 }else {
...
try {
		Debug.PushSubsStack("JobDone (iniciodocente) ","iniciodocente",3,iniciodocente.mostCurrent.activityBA,iniciodocente.mostCurrent,70);
...
Debug.ShouldStop(16777216);
iniciodocente.mostCurrent.__c.runVoidMethod ("LogImpl","52031635",_job.getField(true,"_errormessage" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("opcionregistro_Click (iniciodocente) ","iniciodocente",3,iniciodocente.mostCurrent.activityBA,iniciodocente.mostCurrent,37);
...
try {
		Debug.PushSubsStack("retroceder_Click (iniciodocente) ","iniciodocente",3,iniciodocente.mostCurrent.activityBA,iniciodocente.mostCurrent,42);
...
try {
		Debug.PushSubsStack("txtContrasenadocente_TextChanged (iniciodocente) ","iniciodocente",3,iniciodocente.mostCurrent.activityBA,iniciodocente.mostCurrent,53);
...
try {
		Debug.PushSubsStack("txtcorreodococente_TextChanged (iniciodocente) ","iniciodocente",3,iniciodocente.mostCurrent.activityBA,iniciodocente.mostCurrent,47);
