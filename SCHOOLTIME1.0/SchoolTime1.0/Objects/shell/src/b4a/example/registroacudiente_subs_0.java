...
try {
		Debug.PushSubsStack("Activity_Create (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,32);
...
try {
		Debug.PushSubsStack("Activity_Pause (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,45);
...
try {
		Debug.PushSubsStack("Activity_Resume (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,41);
...
try {
		Debug.PushSubsStack("btnregistroAcudiente_Click (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,101);
...
_job.runClassMethod (b4a.example.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(_apiaddress),(Object)(RemoteObject.concat(RemoteObject.createImmutable("INSERT INTO tblregistroacudiente(nombreAcudiente, apellidoAcudiente, cedulaAcudiente, codigoAcudiente, correoAcudiente, contrasenaAcudiente) VALUES ('"),registroacudiente.mostCurrent._txtnombreacudiente.runMethod(true,"getText"),RemoteObject.createImmutable("','"),registroacudiente.mostCurrent._txtapellidoacudiente.runMethod(true,"getText"),RemoteObject.createImmutable("','"),registroacudiente.mostCurrent._txtcedulaacudiente.runMethod(true,"getText"),RemoteObject.createImmutable("','"),registroacudiente.mostCurrent._txtcodigoacuente.runMethod(true,"getText"),RemoteObject.createImmutable("','"),registroacudiente.mostCurrent._txtcorreoacudiente.runMethod(true,"getText"),RemoteObject.createImmutable("','"),registroacudiente.mostCurrent._txtcontrasenaacudiente.runMethod(true,"getText"),RemoteObject.createImmutable("')"))));
 };
 }else {
...
try {
		Debug.PushSubsStack("cerrarCodigo_Click (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,159);
...
try {
		Debug.PushSubsStack("hecho_Tick (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,144);
...
try {
		Debug.PushSubsStack("JobDone (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,131);
...
Debug.ShouldStop(16);
registroacudiente.mostCurrent.__c.runVoidMethod ("LogImpl","59175042",RemoteObject.createImmutable("OK, operacion con éxito"),0);
...
Debug.ShouldStop(512);
registroacudiente.mostCurrent.__c.runVoidMethod ("LogImpl","59175047",_job.getField(true,"_errormessage" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("opcioncodigo_Click (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,150);
...
try {
		Debug.PushSubsStack("opcioninicioAcudiente_Click (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,49);
...
try {
		Debug.PushSubsStack("retroceder_Click (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,54);
...
try {
		Debug.PushSubsStack("txtapellidoAcudiente_TextChanged (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,95);
...
try {
		Debug.PushSubsStack("txtcedulaAcudiente_TextChanged (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,65);
...
try {
		Debug.PushSubsStack("txtcodigoAcuente_TextChanged (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,77);
...
try {
		Debug.PushSubsStack("txtconfirmaAcudiente_TextChanged (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,89);
...
try {
		Debug.PushSubsStack("txtcontrasenaAcudiente_TextChanged (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,83);
...
try {
		Debug.PushSubsStack("txtcorreoAcudiente_TextChanged (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,71);
...
try {
		Debug.PushSubsStack("txtnombreAcudiente_TextChanged (registroacudiente) ","registroacudiente",10,registroacudiente.mostCurrent.activityBA,registroacudiente.mostCurrent,59);
