...
try {
		Debug.PushSubsStack("Activity_Create (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,33);
...
try {
		Debug.PushSubsStack("Activity_Pause (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,46);
...
try {
		Debug.PushSubsStack("Activity_Resume (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,42);
...
try {
		Debug.PushSubsStack("btnregistrardocente_Click (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,101);
...
_job.runClassMethod (b4a.example.httpjob.class, "_initialize" /*RemoteObject*/ ,registrodocente.processBA,(Object)(BA.ObjectToString("")),(Object)(registrodocente.getObject()));
 BA.debugLineNum = 113;BA.debugLine="job.PostString(ApiAddress,\"INSERT INTO tblre";
Debug.ShouldStop(65536);
_job.runClassMethod (b4a.example.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(_apiaddress),(Object)(RemoteObject.concat(RemoteObject.createImmutable("INSERT INTO tblregistrodocente(nombreDocente, apellidoDocente, cedulaDocente, codigoDocente, correoDocente, contrasenaDocente) VALUES ('"),registrodocente.mostCurrent._txtnombredocente.runMethod(true,"getText"),RemoteObject.createImmutable("','"),registrodocente.mostCurrent._txtapellidodocente.runMethod(true,"getText"),RemoteObject.createImmutable("','"),registrodocente.mostCurrent._txtceduladocente.runMethod(true,"getText"),RemoteObject.createImmutable("','"),registrodocente.mostCurrent._txtcodigodocente.runMethod(true,"getText"),RemoteObject.createImmutable("','"),registrodocente.mostCurrent._txtcorreodocente.runMethod(true,"getText"),RemoteObject.createImmutable("','"),registrodocente.mostCurrent._txtcondocente.runMethod(true,"getText"),RemoteObject.createImmutable("')"))));
 };
 }else {
...
try {
		Debug.PushSubsStack("cerrarCodigo_Click (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,159);
...
if (RemoteObject.solveBoolean("=",registrodocente._doc,BA.numberCast(double.class, 1))) { 
...
try {
		Debug.PushSubsStack("hecho_Tick (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,144);
...
try {
		Debug.PushSubsStack("JobDone (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,131);
...
Debug.ShouldStop(16);
registrodocente.mostCurrent.__c.runVoidMethod ("LogImpl","53080194",RemoteObject.createImmutable("OK, operacion con éxito"),0);
...
Debug.ShouldStop(512);
registrodocente.mostCurrent.__c.runVoidMethod ("LogImpl","53080199",_job.getField(true,"_errormessage" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("opcioncodigo_Click (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,150);
...
if (RemoteObject.solveBoolean("=",registrodocente._doc,BA.numberCast(double.class, 0))) { 
...
try {
		Debug.PushSubsStack("opcioninicioDocente_Click (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,50);
...
try {
		Debug.PushSubsStack("retroceder_Click (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,55);
...
try {
		Debug.PushSubsStack("txtapellidodocente_TextChanged (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,96);
...
try {
		Debug.PushSubsStack("txtceduladocente_TextChanged (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,66);
...
try {
		Debug.PushSubsStack("txtcodigodocente_TextChanged (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,90);
...
try {
		Debug.PushSubsStack("txtcondocente_TextChanged (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,78);
...
try {
		Debug.PushSubsStack("txtconfirmaciondocente_TextChanged (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,84);
...
try {
		Debug.PushSubsStack("txtcorreodocente_TextChanged (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,72);
...
try {
		Debug.PushSubsStack("txtnombredocente_TextChanged (registrodocente) ","registrodocente",4,registrodocente.mostCurrent.activityBA,registrodocente.mostCurrent,60);
