			...
			If txtcorreoEstudiante.Text.Contains("@") Then
				If txtcorreoEstudiante.Text.Contains(".") Then
					...
					Else
						...
						Dim job As HttpJob
						job.Initialize("", Me)
						job.PostString(ApiAddress,"INSERT INTO tblregistroestudiante(nombreEstudiante, apellidoEstudiante, identificacionEstudiante, matriculaEstudiante, codigoGrupo, correoEstudiante, contrasenaEstudiante) VALUES ('"&txtnombreEstudiante.Text&"','"&txtapellidoEstudiante.Text&"','"&txtidentificacion.Text&"','"&txtmatricula.Text&"','"&txtcodigogrupo.Text&"','"&txtcorreoEstudiante.Text&"','"&txtcontrasenaEstudiante.Text&"')")
					End If
				Else
