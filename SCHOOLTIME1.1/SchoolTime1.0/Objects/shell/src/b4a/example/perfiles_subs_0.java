...
try {
		Debug.PushSubsStack("Activity_Create (perfiles) ","perfiles",2,perfiles.mostCurrent.activityBA,perfiles.mostCurrent,25);
...
try {
		Debug.PushSubsStack("Activity_Pause (perfiles) ","perfiles",2,perfiles.mostCurrent.activityBA,perfiles.mostCurrent,35);
...
try {
		Debug.PushSubsStack("Activity_Resume (perfiles) ","perfiles",2,perfiles.mostCurrent.activityBA,perfiles.mostCurrent,31);
...
try {
		Debug.PushSubsStack("btnacudiente_Click (perfiles) ","perfiles",2,perfiles.mostCurrent.activityBA,perfiles.mostCurrent,50);
...
try {
		Debug.PushSubsStack("btndocente_Click (perfiles) ","perfiles",2,perfiles.mostCurrent.activityBA,perfiles.mostCurrent,40);
...
try {
		Debug.PushSubsStack("btnestudiante_Click (perfiles) ","perfiles",2,perfiles.mostCurrent.activityBA,perfiles.mostCurrent,45);
...
try {
		Debug.PushSubsStack("retroceder_Click (perfiles) ","perfiles",2,perfiles.mostCurrent.activityBA,perfiles.mostCurrent,55);
